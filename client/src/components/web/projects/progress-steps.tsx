    ...
    return (
        <div className="flex justify-between items-center gap-4 max-w-7xl mx-auto  w-full">
            ...
            <div className="flex-1 flex flex-col justify-center mx-auto items-center gap-2">
                ...
                <p className='text-center text-black font-normal text-lg mt-2'>Your progress</p>
            </div>
            {step > 1 && <div className='flex-1 '>
                <button className='mx-auto w-[60px] h-[60px] md:w-[104px] md:h-[104px] rounded-full bg-clr-blue-primary text-wrap flex justify-center items-center font-light text-xl text-white outline-1 outline-clr-blue-primary outline outline-offset-8' onClick={handleNext}>Next</button>
                </div>}
        </div>
    )
}
